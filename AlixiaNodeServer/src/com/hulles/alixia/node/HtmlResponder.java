...
import com.hulles.alixia.node.ng.TinyPages;
import com.hulles.alixia.prong.shared.SerialProng;

public final class HtmlResponder implements JavaCallback {
//	private final static Logger logger = Logger.getLogger("AlixiaWebServer.HtmlResponder");
//	private final static Level LOGLEVEL = AlixiaConstants.getAlixiaLogLevel();
	...
	public Object invoke(V8Object receiver, V8Array parameters) {
		...
		if (parameters.length() < 2) {
			AlixiaUtils.error("HtmlResponder: paramenters error");
