...
import com.hulles.alixia.delta.deepspeech.swig.SWIGTYPE_p_ModelState;
import com.hulles.alixia.delta.deepspeech.swig.SWIGTYPE_p_p_ModelState;
import com.hulles.alixia.delta.deepspeech.swig.SWIGTYPE_p_p_StreamingState;
import com.hulles.alixia.delta.deepspeech.swig.impl;
...
public class DeepSpeechModel {
    ...
    */
    public static void feedAudioContent(DeepSpeechStreamingState ctx, short[] buffer, int buffer_size) {
    ...
    */
    public static String intermediateDecode(DeepSpeechStreamingState ctx) {
    ...
    */
    public static String finishStream(DeepSpeechStreamingState ctx) {
    ...
    * @note This method will free the state pointer (@p ctx).
    */
    public static Metadata finishStreamWithMetadata(DeepSpeechStreamingState ctx) {
