...
final public class FoxtrotPhysicalState {
	...
	public String toString() {
		...
		sb.append("<dd>");
        sb.append(AlixiaUtils.formatElapsedSeconds(seconds));
        sb.append("</dd>\n");
		...
		kbStr = AlixiaUtils.formatKb(this.getTotalMemoryKb());
		sb.append("<dd>");
        sb.append(kbStr);
        sb.append("</dd>\n");
		sb.append("<dt>Free memory</dt>\n");
		kbStr = AlixiaUtils.formatKb(this.getFreeMemoryKb());
		sb.append("<dd>");
        sb.append(kbStr);
        sb.append("</dd>\n");
		sb.append("<dt>Total swap</dt>\n");
		kbStr = AlixiaUtils.formatKb(this.getTotalSwapKb());
		sb.append("<dd>");
        sb.append(kbStr);
        sb.append("</dd>\n");
		sb.append("<dt>Free swap</dt>\n");
		kbStr = AlixiaUtils.formatKb(this.getFreeSwapKb());
		sb.append("<dd>");
        sb.append(kbStr);
        sb.append("</dd>\n");
		...
		kbStr = AlixiaUtils.formatKb(this.getJVMFreeMemoryKb());
		sb.append("<dd>");
        sb.append(kbStr);
        sb.append("</dd>\n");
		sb.append("<dt>JVM Max Memory</dt>\n");
		kbStr = AlixiaUtils.formatKb(this.getJVMMaxMemoryKb());
		sb.append("<dd>");
        sb.append(kbStr);
        sb.append("</dd>\n");
		sb.append("<dt>JVM Total Memory</dt>\n");
		kbStr = AlixiaUtils.formatKb(this.getJVMTotalMemoryKb());
		sb.append("<dd>");
        sb.append(kbStr);
        sb.append("</dd>\n");
		...
		if (this.getServerUptime() != null) {
			...
			etStr = AlixiaUtils.formatElapsedSeconds(this.getServerUptime());
			sb.append("<dd>");
            sb.append(etStr);
            sb.append("</dd>\n");
		}
		...
		if (this.getServerKBytes() != null) {
			...
			kbStr = AlixiaUtils.formatKb(this.getServerKBytes());
			sb.append("<dd>");
            sb.append(kbStr);
            sb.append("</dd>\n");
		}		
		...
		for (FoxtrotFS fs : this.getFileSystems()) {
            ...
            sb.append("</dt>\n");
			kbStr = AlixiaUtils.formatKb(fs.getTotalSpaceKb());
			sb.append("<dd>Total Space ");
            sb.append(kbStr);
			kbStr = AlixiaUtils.formatKb(fs.getUsedSpaceKb());
			sb.append(" | Used Space ");
            sb.append(kbStr);
			kbStr = AlixiaUtils.formatKb(fs.getFreeSpaceKb());
		...
		for (NetworkDevice device : this.getNetworkDevices()) {
            ...
            sb.append("</dt>\n");
			kbStr = AlixiaUtils.formatKb(device.getTransmitKb());
			sb.append("<dd>Transmitted ");
            sb.append(kbStr);
			kbStr = AlixiaUtils.formatKb(device.getReceiveKb());
			sb.append(" | Received ");
            sb.append(kbStr);
            sb.append("</dd>\n");
		}
