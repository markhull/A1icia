...
import com.hulles.a1icia.webx.client.services.MindService;
...
final public class MindServiceImpl extends RemoteServiceServlet implements MindService {
	...
	private static final String BUNDLE_NAME = "com.hulles.a1icia.webx.server.Version";
	private static final String MEDIA_URL = "a1iciaweb/services/media?mmd=";
	private static final boolean USE_TTS = true;
//	private final static Logger logger = Logger.getLogger("A1iciaWeb.MindServiceImpl");
//	private final static Level LOGLEVEL = Level.INFO;
	...
	public SerialConsoleOut receiveConsole(SerialProng prong) throws ProngException {
		...
		String prongKey;
		String expl;
		List<A1iciaClientObject> clientObjects;
	...
	private static void processTTS(String text, List<String> urls, List<MediaFormat> formats) {
		...
		key = A1iciaMediaServlet.saveAudioBytes(format, audioBytes);
		url = MEDIA_URL + key;
		urls.add(url);
		formats.add(format);
	}
