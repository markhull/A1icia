 ...
 * <p>
 * Any Alixia application should <b>ALWAYS</b> be able to get its Station from the local machine,
...
public final class Station implements Serializable {
	...
	public void ensureStationExists() {
		...
		if (keyMap == null) {
			throw new AlixiaException("AlixiaStation: station does not exist");
		}
	}
	...
	private static Station getJebusStation() {
		...
		try (Jedis jebus = jebusPool.getResource()) {
			stationKeyBytes = JebusBible.getBytesKey(JebusBible.JebusKey.ALIXIASTATIONKEY, jebusPool);
