 ...
 *******************************************************************************/
package com.hulles.alixia.prong.server;
...
import com.hulles.alixia.prong.shared.SharedUtils;
...
public final class Prongz {
    // for now, we don't use the JebusBible in API
    private final static String ALIXIAPRONGKEY = "alixia:prong";
