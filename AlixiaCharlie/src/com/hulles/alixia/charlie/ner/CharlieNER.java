...
import com.hulles.alixia.charlie.ner.CharlieDictionary.DictionaryType;
...
final public class CharlieNER {
	...
	public CharlieNER() {
        ...
        try {
            ...
            throw new AlixiaException("Can't create NER URL", ex);
        }
		try {
			...
			throw new AlixiaException("Can't load NER model(s)", e);
		}
