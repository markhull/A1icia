...
//	private final static Logger logger = Logger.getLogger("AlixiaMedia.TTSPico");
...
*/	
    ...
    public static byte[] ttsToBytes(Language lang, String text) {
        ...
        try {
			...
			throw new AlixiaMediaException("TTSPico: can't run pico2wave", ex);
        } finally {
	        try {
	            if (tempFile != null) {
	                Files.delete(tempFile);
				...
				throw new AlixiaMediaException("TTSPico: can't delete temp file", ex);
	        }
	    }
    }
    ...
    public static void ttsToAudio(Language lang, String text) {
        ...
        try {
			...
			throw new AlixiaMediaException("TTSPico: can't play audio bytes", ex);
		}
    }
}
